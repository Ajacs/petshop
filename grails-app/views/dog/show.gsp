	...
	<body>
		...
		<div id="show-dog" class="content scaffold-show" role="main">
			...
			<ol class="property-list dog">
				...
				<g:if test="${dogInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="dog.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${dogInstance}" field="description"/></span>
				...
				<g:if test="${dogInstance?.registerAt}">
				<li class="fieldcontain">
					<span id="registerAt-label" class="property-label"><g:message code="dog.registerAt.label" default="Register At" /></span>
					
						<span class="property-value" aria-labelledby="registerAt-label"><g:formatDate date="${dogInstance?.registerAt}" /></span>
